...
- CSS Layout Design Guidelines の全7項目チェックリストを実践できる
- 新規コンポーネント追加時のレイアウト崩れを事前に防止できる
- コードレビュー時に Guidelines 準拠を確認できる

## 概要

CSS Layout Design Guidelines 第5章のチェックリストを実践的に使うための教材です。
新規コンポーネントを追加する際、この7項目を確認することで
レイアウト崩れを未然に防ぐことができます。

## 7項目チェックリスト（Guidelines準拠）
